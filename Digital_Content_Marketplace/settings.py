"""
Django settings for Digital_Content_Marketplace project.
...
SECRET_KEY = 'django-insecure-h2&-muhoc-*s)7%wqryx@cl$zpqz91=#e89nxvrbi*2huq!=yo'
...
INSTALLED_APPS = [
    ...
    'mathfilters',
    # Custom Apps
    'apps.authentication',   # Our custom authentication app
...
ROOT_URLCONF = 'Digital_Content_Marketplace.urls'
...
WSGI_APPLICATION = 'Digital_Content_Marketplace.wsgi.application'
